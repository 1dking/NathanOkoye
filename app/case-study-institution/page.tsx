      ...
      <div className="container">
        ...
        <div className="img-placeholder img-placeholder--wide mt-7">
          <div className="img-placeholder__inner">
            ...
            <p className="img-placeholder__caption">Anonymised editorial image opening day of the institution. Crowd, city skyline, civic energy.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="container">
        <div className="img-placeholder img-placeholder--banner">
          <div className="img-placeholder__inner">
            ...
            <p className="img-placeholder__caption">Brand artefacts logo system, platform screens, launch creative. Anonymised.</p>
          </div>
        </div>
      </div>
    </section>

    ...
    <section className="section">
      <div className="container">
        ...
        <div className="prose stack">
          ...
          <p>The results that positioning work has produced: a $135 million advisory engagement acquired through brand clarity alone, 15,000 people at an event built from no brand foundation, $39,378 in revenue unlocked by repositioning an expert's first product, and a first sold-out event in 15 years for an established organisation.</p>

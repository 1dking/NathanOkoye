    ...
    <section className="section-sm" style={{ paddingTop: 'clamp(3rem, 7vw, 5rem)' }}>
      <div className="container">
        ...
        <figure className="img-frame img-frame--wide mt-7">
          <Image
            src="/images/case-study-arts-hero.png"
            alt="Performance hall, audience in low light. The room finally full."
            width={1600}
            height={900}
            priority
          />
    ...
    <section className="image-band">
      <div className="container">
        <figure className="img-frame img-frame--banner">
          <Image
            src="/images/case-study-arts-banner.png"
            alt="Campaign artefacts — content samples, paid creative, performance dashboard. Anonymised."
            width={1600}
            height={686}
            loading="lazy"
          />
